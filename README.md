...
|-------|----------|--------|---------------|------|
| amazon_us | 2026-02-17 | 153 | 150 ✅ | ⚠️ Session 過期 |
| bestbuy_us | 2026-02-17 | 0 | 4 ⚠️ | 🔧 Headless 被擋 |
| walmart_us | 2026-02-17 | 0 | 40 ⚠️ | 🔧 Beauty 失敗 |
...
| 指標 | 數值 |
|------|------|
| Discovery 產品 | 194 (Amazon 150 + Walmart 40 + Best Buy 4) |
| 新增至現有類別 | 23 |
| 萃取數量 | 0 (Session 過期阻擋) |
| 報告產出 | 0 |
| REVIEW_NEEDED 報告 | 25 |
| 待重新抓取 | 23 (Amazon session 過期) |
